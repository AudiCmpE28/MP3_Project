...
void sj2_cli__init(void) {
  ...
  /*/////////////////////////////////////////////////////////////////////////////////////////
                                   OUR own cli handler
   ////////////////////////////////////////////////////////////////////////////////////// */
  static app_cli__command_s cli_watchdog = {.command_name = "watchdog",
                                            .help_message_for_command =
                                                "This task is for the watchdog task: Resume or Suspend\n",
                                            .app_cli_handler = cli__watchdog_transmission};

  /*/////////////////////////////////////////////////////////////////////////////////////////
                                    MP3 CLI Handler
    ////////////////////////////////////////////////////////////////////////////////////// */
  static app_cli__command_s cli_MP3 = {.command_name = "mp3",
                                       .help_message_for_command = "This task is for the MP3: Play Song\n",
  ...
  app_cli__add_command_handler(&sj2_cli_struct, &cli_watchdog); /*cli handler for watchdog*/
  app_cli__add_command_handler(&sj2_cli_struct, &cli_MP3);      /*cli handler for MP3*/
