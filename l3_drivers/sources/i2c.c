...
static bool i2c__handle_state_machine(i2c_s *i2c) {
  enum {
    ...
    /*/////////////////////////////////////////////////////////////////////////////////////////////////////////
                               Slave state machine (using one board)
   ////////////////////////////////////////////////////////////////////////////////////////////////////// */
    // Table 515
    ...
    // Table 514
    // Master Receiver States (SR):
    I2C__STATE_SR_SLAVE_READ_ACK = 0x60,
    I2C__STATE_SR_SLAVE_GENERALCALL_ACK = 0x70,
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////// */
  ...
  case I2C__STATE_SR_SLAVE_READ_ACK: // = 0x60,
    i2c->slave_register_address = 0;
    i2c->received_first_byte = false;
    i2c__set_ack_flag(lpc_i2c);
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    break;

  case I2C__STATE_SR_SLAVE_ACK_SENT: // = 0x80,
    if (i2c->received_first_byte) {
      i2c_slave_callback__write_memory(i2c->slave_register_address++, lpc_i2c->DAT);
    } else {
      i2c->received_first_byte = true;
      i2c->slave_register_address = lpc_i2c->DAT; // R# that master sends
    }
    i2c__set_ack_flag(lpc_i2c);
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    break;

  case I2C__STATE_SR_SLAVE_NACK_SENT: // = 0xA0
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    break;
